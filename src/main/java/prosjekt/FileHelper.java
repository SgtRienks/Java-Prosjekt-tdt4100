...
/**
 * A helper class for reading and writing to files. You can use this for your project.
 */
public class FileHelper {
    ...
    /**
     * Write the given lines to the file at the given path. Will overwrite any existing
     * file.
     *
     * @param path  The path
